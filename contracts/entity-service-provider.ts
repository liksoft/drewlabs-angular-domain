...
export interface IEntityServiceProvider {
  /**
   ...
   */
  post( path: string, body: any, options?: any, fullpath?: boolean): Observable<any>;
   ...
   * @param fullpath Specifies if full url is passed or not
   */
  get(path: string, options?: any, fullpath?: boolean): Observable<any>;
   ...
   * @param fullpath Specifies if full url is passed or not
   */
  put( path: string, body: any, options?: any, fullpath?: boolean): Observable<any>;
   ...
   * @param fullpath Specifies if full url is passed or not
   */
  delete(path: string, options?: any, fullpath?: boolean): Observable<any>;
}
