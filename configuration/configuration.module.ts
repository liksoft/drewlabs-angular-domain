...
import { ANGULAR_ENVIRONMENT_MANAGER, ENVIRONMENT, JSON_CONFIG_MANAGER, JSON_CONFIG_URL } from './services/tokens';
...
export class ConfigurationModule {
  static forRoot(config: ModuleConfig): ModuleWithProviders<ConfigurationModule> {
    return {
