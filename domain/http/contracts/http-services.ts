...
export interface HttpServices {
   ...
   */
  post( path: string, body: any, options?: any, fullUrl?: boolean): Observable<any>;
   ...
   * @param fullUrl Specifies if full url is passed or not
   */
  get(path: string, options?: any, fullUrl?: boolean): Observable<any>;
   ...
   * @param fullUrl Specifies if full url is passed or not
   */
  put( path: string, body: any, options?: any, fullUrl?: boolean): Observable<any>;
   ...
   * @param fullUrl Specifies if full url is passed or not
   */
  delete(path: string, options?: any, fullUrl?: boolean): Observable<any>;
