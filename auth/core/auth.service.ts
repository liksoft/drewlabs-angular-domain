...
export class AuthService {
  ...
  /**
   * @param router Angular [[Router]] library
   * @param sessionStorage Inject [[SessionStorage]] class
   * @param tokenServiceProvider Inject [[AuthTokenService]] class
   * @param userService Inject [[AuthUserService]] class instance
   */
  constructor(
